...
public class OverScrollLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public void refreshComplete() {
        if (targetView!=null){
            if (targetView instanceof AbsListView) ((BaseAdapter)((ListView) targetView).getAdapter()).notifyDataSetChanged();
            if (targetView instanceof RecyclerView) ((RecyclerView) targetView).getAdapter().notifyDataSetChanged();
        }
        noMore =false;
